...
//
// #[derive(Clone)]
// pub struct SlidingWindowWithTimeFuncOp<
//     Source,
//     TimeFunction,
//     Scheduler,
// > {
...
// }
//
// impl<Item, Err, O, Source, TimeFunction, Scheduler> Observable<Item, Err, O>
// for SlidingWindowWithTimeFuncOp<Source, TimeFunction, Scheduler>
// where
...
//
// #[derive(Clone)]
// pub struct SlidingWindowWithTimeFuncObserver<Observer, Buffer, Handler> {
//     observer: Observer,
//     buffer: Buffer,
//     handler: Handler,
// }
